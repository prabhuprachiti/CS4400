...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(360, 60, 81, 20))
        self.label_2.setObjectName("label_2")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setEditTriggers(QtWidgets.QTableWidget.NoEditTriggers)
        self.tableWidget.setGeometry(QtCore.QRect(280, 160, 261, 192))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(360, 420, 93, 28))
        ...
        # self.label_3.setGeometry(QtCore.QRect(300, 120, 91, 16))
        ...
        self.pushButton.setGeometry(QtCore.QRect(500, 110, 120, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "View Visitors"))
        self.tableWidget.setSortingEnabled(False)
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Username"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Email"))
        self.pushButton_2.setText(_translate("MainWindow", "Delete Visitor"))
        self.pushButton.setText(_translate("MainWindow", "Search Visitor"))
